...
func (n *Neutron) AssociateFloatingIp(ctx context.Context, input *common.AssociateFloatingIpInput) (err error) {
	var (
	...
	// Update the floating IP to associate it with the specified port ID
