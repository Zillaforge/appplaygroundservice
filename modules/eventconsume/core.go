...
import (
	eventConsumeCom "AppPlaygroundService/modules/eventconsume/common"
	"AppPlaygroundService/modules/eventconsume/redis/sentinel"
	redisCtlConsumer "AppPlaygroundService/server/event_router"
