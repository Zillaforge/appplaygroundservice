...
%define Name AppPlaygroundService
...
License:        GPL
Release:        %{Release}
Summary:        ASUS AppPlaygroundService package
Url:            asus.com
Group:          developer
...
cp AppPlaygroundService.service %{BuildRoot}/etc/systemd/system/
...
%config /etc/systemd/system/AppPlaygroundService.service
